...
# client.all_repositories('learn-co-students', page:1)


# # These two are the same thing:
# crepos=client.repos('learn-co-students', per_page: 100)
# repos = Octokit.repos('learn-co-students', page: 2, per_page: 100)
